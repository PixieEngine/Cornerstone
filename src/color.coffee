(->
  ...
  window.Color = (color) ->
    ...
    if arguments.length == 2
      if arguments[0].length == 3 && Object.prototype.toString.call(arguments[0]) == '[object Array]'
    ...
    else if arguments.length > 2 && Object.prototype.toString.call(arguments[0]) == '[object Array]' 
      alpha = if arguments[3]? then arguments[3] else 1
      parsedColor = [
